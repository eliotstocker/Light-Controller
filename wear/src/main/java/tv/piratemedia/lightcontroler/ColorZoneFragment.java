...
public class ColorZoneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        if(args.getInt(ARG_OBJECT) > 4) {
            ((MainActivity) getActivity()).findViewById(R.id.rim).setBackground(getResources().getDrawable(R.drawable.white_border));
        } else {
            ((MainActivity) getActivity()).findViewById(R.id.rim).setBackground(getResources().getDrawable(R.drawable.color_border));
        }
